...
# Officiële Excel-cijfers inlezen (vereist dat bestand in dezelfde map staat)
@st.cache_data
def laad_officiele_data():
    xls = pd.ExcelFile("EAK_TRANSITIE_NL_JJ_P (3).xlsx")
