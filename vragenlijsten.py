...
vragen_A = [
    ("Wat is welbevinden en betrokkenheid? Wat doe je als deze laag is?",
     "Welbevinden = hoe goed het kind zich voelt. Signalen van welbevinden kan je zien aan de gezichtsuitdrukkingen, spontaniteit, openheid, energie, lichaamshouding,...; betrokkenheid = hoe diep het speelt. Signalen betrokkenheid: energie en enthousiasme, hoge concentratie, doorzettingsvermogen, creativiteit, alertheid, nauwkeurigheid,..."),
    ("Wat is educatieve ondersteuning?",
     "Stimuleren van de ontwikkeling, observeren, aansluiten bij noden, activiteiten, vrij spel, taalondersteunig (praten met peuters en baby's is zeer belangrijk."),
    ("Wat is jouw draagkracht? Wat doe je als die minder wordt?",
     "Draagkracht is de maximale stress, verantwoordelijkheid of belasting die iemand kan dragen. Wat kan je doen als die minder wordt?Steun zoeken, grenzen stellen, praten met collega's."),
    ("Hoe zijn de leefgroepen ingedeeld?",
     "Baby's → verzorging; peuters → structuur."),
    ("Hoe doe jij toezicht op rustruimtes?",
     "Regelmatig controleren, rust bewaken, camerabeelden bekijken, in de kamers gaan kijken om de 15 minuten, lijsten aftekenen na controle."),
    ("Hoe bevorder je contact met ouders?",
     "Warme overdrachten, formulieren, open communicatie, tijd maken voor gesprekjes met ouders."),
    ...
    ("Waar registreer jij je uren? Wat is ratio?",
     "Aanwezigheidsblad/digitaal. Ratio = begeleiders/kinderen. We streven naar 1 op 7 in Droomhuis, Droomkind en Babydroom. In 't Kinderhof is dit 1 op 8")
]
...
vragen_B = [
    ...
    ("Ontwikkelingsstimulering – hoe doe jij dit?",
     "Zowel tijdens vrij spel al geleide activiteiten materialen en spelaanbod voorzien dat aansluit bij het ontwikkelingsniveau van de kinderen. Een omgeving scheppen waar kinderen kunnen experimenteren."),
